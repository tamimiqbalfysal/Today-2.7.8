...
export default function VideoBazaarPage() {
  ...
  useEffect(() => {
    ...
    const userPostsQuery = query(postsCollection, where('authorId', '==', user.uid), where('category', '==', 'Video Bazaar'));
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    if (!productName || !description || !price || mediaFiles.length === 0 || !user) {
      toast({ variant: 'destructive', title: 'Missing Fields', description: 'Please fill out all fields and select at least one video.' });
      return;
    }
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Sell your unique video creations to the community.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <Card>
                <CardHeader>
                  <CardTitle>List a New Video Product</CardTitle>
                ...
                <CardContent>
                  <form onSubmit={handleFormSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="file-upload" type="file" ref={fileInputRef} onChange={handleFileChange} accept="video/*" className="hidden" disabled={isSubmitting} multiple/>
                      <Button type="button" variant="outline" className="w-full" onClick={() => fileInputRef.current?.click()} disabled={isSubmitting}>
                        <Upload className="mr-2 h-4 w-4" />
                        {mediaFiles.length > 0 ? `Add More Videos (${mediaFiles.length})` : 'Upload Videos'}
                      </Button>
            ...
            <div className="space-y-6">
              ...
              {isLoadingProducts ? (
                ...
                <div className="text-center text-muted-foreground py-16 border-2 border-dashed rounded-lg">
                  ...
                  <p>Use the form to list your first product in the Video Bazaar.</p>
                </div>
              )}
            </div>
          </div>
